...
namespace Http
{
	namespace Server
	{
		...
		Request::Request()
		{
			this->m_enmEntityType = ENTITY_TYPE::HTTP_REQUEST;
			this->m_bIsTypeSet = false;
			this->m_rtType = RequestType::HTTP;
		...
		//Copy Constructor
		///////////////////////////////////////////////////////////////////////////////
		Request::Request(const Request& request) : Entity(request)
		{
			this->m_bIsTypeSet = request.GetIsTypeSet();
			this->m_rtType = request.GetRequestType();
		...
		{
			this->m_enmEntityType = request.GetEntityType();
			this->m_bIsTypeSet = request.GetIsTypeSet();
			this->m_rtType = request.GetRequestType();
			this->m_szMethod = request.GetMethod();
			this->m_szURI = request.GetUri();
